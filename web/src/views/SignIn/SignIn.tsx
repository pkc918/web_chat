...
export const SignIn: React.FC = () => {
    ...
    return (
        <div className="m-auto">
            ...
            <div>
                <div className="flex justify-center">
                    ...
                    <div className="signBox  mt-[1rem]">
                        ...
                        <div>
                            <Input
                                className="inputBorder px-2 my-[1rem]"
                                type="text"
                            ...
                            { signTitleIndex === 0 ? (
                                ...
                                >
                                    <div
                                        className="h-[40px] text-[0.5rem] whitespace-nowrap flex items-center rounded-r-[5px] border-2 border-l-0 border-black border-solid px-[10px] text-white bg-[#3361ff] cursor-pointer">
                                        获取验证码
                                    </div>
                                </Input>
                            ) }
            ...
            <div className="py-[1rem] rounded-b-[10px]">
                注册登录即表示同意
